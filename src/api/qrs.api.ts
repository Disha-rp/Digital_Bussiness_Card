...
export class QrsApi implements IQrsApi {
  ...
  async getQrById(id: string): Promise<ApiResponse<QrTracQr>> {
    return this.client.request<QrTracQr>(`/qrs-api/${id}`, {
      method: 'GET',
    });
  }
  ...
  async deleteQr(id: string): Promise<ApiResponse<void>> {
    return this.client.request<void>(`/qrs-api/${id}`, {
      method: 'DELETE',
    });
  }
  ...
  async listTeamQrs(
    ...
    return this.client.request<QrTracPaginatedData<QrTracQr>>(`/qrs-api/v2/teams/${teamId}${query}`, {
      method: 'GET',
    });
  }

  async checkSlugAvailability(displayId: string): Promise<ApiResponse<QrTracAvailabilityData>> {
    return this.client.request<QrTracAvailabilityData>(`/qrs-api/availability/${displayId}`, {
      method: 'GET',
    });
  }

  async duplicateQr(id: string, name?: string): Promise<ApiResponse<QrTracQr>> {
    return this.client.request<QrTracQr>(`/qrs-api/duplicate/${id}`, {
      method: 'POST',
